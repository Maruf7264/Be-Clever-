                ...
                <div class="card-front">
                  <div class="center-wrap">
                    ...
                    <div class="section text-center">
                      ...
                      <input type="submit" id="submit" name="submit" class="btn mt-4" value="Login">
                    </div>
                  </form>
                  </div>
                </div>
                <div class="card-back">
                  ...
                  <form action="register.php" method="post">
                    ...
                    <div class="section text-center">
                      ...
                      <div class="form-group">
                        <input type="text" name="fname" class="form-style" placeholder="Full Name">
                        <i class="input-icon uil uil-user"></i>
                      </div>
                      <div class="form-group mt-2">
                        <input type="tel" name="mobile" class="form-style" placeholder="Phone Number">
                      ...
                      <input type="submit" value="submit" name="submit" class="btn mt-4" value="Register">
                    </div>
                    </form>
                  </div>
                </div>
